...
cat ${PAR_DIR}/Fimpute_NONGENOTYPEDPARENTSCHECK.ctr | sed "s/BTAX/BTA${BTA}/g" | sed "s/XXXXXXX/${breed}/g" | sed "s/ZZZZZZZ/${parent}/g" >  ${breed}_NONGENOTYPEDPARENTSCHECK.ctr
